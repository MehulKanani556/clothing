...
exports.addToCart = async (req, res) => {
    try {
        ...
        const populatedCart = await Cart.findById(cart._id).populate('items.product', 'name images brand variants category packageInfo');
...
exports.getCart = async (req, res) => {
    try {
        const userId = req.user._id;
        const cart = await Cart.findOne({ user: userId }).populate('items.product', 'name images brand variants price category packageInfo');
