...
const Sidebar = ({ isCollapsed }) => {
    ...
    const [expandedMenus, setExpandedMenus] = useState(['ecommerce', 'products', 'orders']);
    ...
    return (
        <div className={`${isCollapsed ? 'w-[70px]' : 'w-64'} bg-white text-gray-700 min-h-screen flex flex-col shadow-xl font-sans text-sm transition-all duration-300 border-r border-gray-100`}>
            {/* Logo Section */}
